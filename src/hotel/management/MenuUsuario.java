...
public class MenuUsuario extends JFrame {
    ...
    public MenuUsuario() {
        ...
        String textoDescripcion = "<html><body>Sistema de reserva de hotel. Con nuestra herramienta, podrás tener un control completo y eficiente del flujo de reservas y huéspedes de tu hotel. <br> Simplifica la gestión de manera óptima y sencilla.   </body></html>";
        ...
        String textoDescripcion1 = "<html><body> Benefíciate de un control detallado y exhaustivo de tus reservas y huéspedes. Nuestra herramienta te ofrece acceso a funciones especiales diseñadas para tareas específicas, tales como:</body></html>";
    ...
    public void mostrarMenuUsuario() {
        // Crear un nuevo JPanel para el menú de usuario
        JPanel panelMenuUsuario = new JPanel();
        panelMenuUsuario.setBounds(256, 255, 688, 310);
        panelMenuUsuario.setBackground(Color.WHITE);
        panelMenuUsuario.setLayout(null);
        contentPane.add(panelMenuUsuario);

        // Crear y configurar los componentes del menú de usuario
        JLabel lblMenuUsuario = new JLabel();
        lblMenuUsuario.setBounds(0, 0, 200, 30);
        lblMenuUsuario.setFont(new Font("Roboto", Font.BOLD, 18));
        panelMenuUsuario.add(lblMenuUsuario);

        JButton btnOpcion1 = new JButton("Opción 1: Registro de Reservas y Huéspedes");
        btnOpcion1.setBounds(50, 190, 350, 25);
        panelMenuUsuario.add(btnOpcion1);

        JButton btnOpcion2 = new JButton("Opción 2: Edición de Reservas y Huéspedes existentes");
        btnOpcion2.setBounds(50, 225, 350, 25);
        panelMenuUsuario.add(btnOpcion2);

        JButton btnOpcion3 = new JButton("Opción 3: Eliminar todo tipo de registros");
        btnOpcion3.setBounds(50, 260, 350, 25);
        panelMenuUsuario.add(btnOpcion3);
        
        URL location = getClass().getResource("/src/imagenes/imagenes/reservas-img-3.png");
        if (location != null) {
            ImageIcon imageIcon = new ImageIcon(location);
            lblMenuUsuario.setIcon(imageIcon);
      }
    }
}
